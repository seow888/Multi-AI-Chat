...
from PyQt6.QtCore import Qt, QThread, pyqtSignal, QDir, QSize, QSettings # Added QSettings
    ...
    def attach_file(self):
        ...
        if file_path and os.path.exists(file_path):
            ...
            if file_size > 100 * 1024 * 1024:
                ...
                return
            # Start file processing in thread
            self.file_worker = FileProcessor(file_path)
            self.file_worker.finished.connect(self.handle_file_result)
